  ...
  return (
    <div className="mt-28 md:mt-0 w-full aspect-video pt-[14%] px-6 md:px-12 absolute text-white md:bg-gradient-to-r from-black">
      ...
      <div className="my-2 md:my-0">
        <button className="hidden md:inline-block bg-white text-black p-0.5 md:p-2 px-2 md:px-10 text-lg  rounded-lg hover:bg-opacity-80">
          <div className="flex">
            <FaPlay className="mt-[5px] mr-[5px]" />
            Play
          </div>
        </button>
        <button className="hidden md:inline-block mx-2 bg-gray-500 text-white p-2 px-8 text-lg bg-opacity-50 rounded-lg">
          <div className="flex">
