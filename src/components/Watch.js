      ...
      <div className=" bg-black text-white">
         ...
         <div className="md:flex p-[30px]">
            ...
            <div className="md:w-[780px]  md:mr-[95px]">
              ...
              <div className="text-yellow-400 text-sm md:text-none mt-3 mb-3">{MovieDetail?.tagline}</div>
              ...
              <div className="md:flex mt-7 mb-3">
                <div className="flex md:flex-none">
                  ...
                  <div className="md:text-l w-56  ml-2 md:ml-0 text-gray-400 brightness-105 "> {MovieDetail?.status}</div>
                </div>
  
                <div className="flex md:flex-none">
                  <span className=" text-white">Release Date :</span>
                  <div className="md:text-l md:w-56 ml-2 md:ml-0 text-gray-400 brightness-105 "> {MovieDetail?.release_date}</div>
                </div>
  
                <div className="flex md:flex-none">
                  <span className=" text-white">Runtime :</span>
                  <div className="md:text-l w-56  ml-2 md:ml-0 text-gray-400 brightness-105 ">{Math.floor((MovieDetail?.runtime)/60)}h {Math.floor((MovieDetail?.runtime)%60)}m</div>
                </div>
                ...
                {Cast?.cast.map((item) => {
                  ...
                  return(
                    <div  className="" key={item.id}>
                      <div >
                        <div className="p-3  w-[100px]"><img className="h-[85px] rounded-full" alt="profile_image" src={IMG_CDN + item.profile_path}/></div>
